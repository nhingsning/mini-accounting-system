    ...
    <div class="container-fluid py-3">
      ...
      <form class="panel" method="POST" action="{{ route('invoices.update', $invoice) }}" autocomplete="off">
        ...
        <div class="panel-header d-flex align-items-center">
          ...
          <div class="ms-auto text-muted">No. <span class="fw-600">{{ $invoice->number }}</span></div>
        </div>
        ...
        <div class="panel-body">
          <div class="row g-3">
            ...
            <div class="col-md-4">
              ...
              <div class="form-text">พิมพ์ค้นหา แล้วเลือกเพื่อดึงข้อมูลลูกค้ามาใส่อัตโนมัติ</div>
            </div>
